...
begin
  ...
  counter += 1
  Rails.logger.info "Changed to HCT AdminSet and Model for work #{id}"
rescue => e
  Rails.logger.error "\tFailed to change to HCT AdminSet or Model for work #{id}: #{e.message}"
end
...
Rails.logger.info "Done. Changed a total of #{counter} works."
