...
ActiveRecord::Schema.define(version: 20180412183213) do
  ...
  create_table "other_options", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "work_id"
    t.string   "name"
    t.string   "property_name"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["name"], name: "index_other_options_on_name", using: :btree
    t.index ["work_id"], name: "index_other_options_on_work_id", using: :btree
  end
  ...
  create_table "qa_local_authority_entries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["qa_local_authority_id"], name: "index_qa_local_authority_entries_on_qa_local_authority_id", using: :btree
