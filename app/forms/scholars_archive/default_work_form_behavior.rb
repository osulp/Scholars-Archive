      ...
      def self.build_permitted_params
        super + self.date_terms + [
          ...
          :member_of_collection_ids,
          {
            ...
            :nested_ordered_description_attributes => [:id, :_destroy, :index, :description],
