module ScholarsArchive
  module EtdWorkFormBehavior
    ...
    included do
      ...
      def primary_terms
        [:nested_ordered_title, :nested_ordered_alt_title, :nested_ordered_creator, :nested_ordered_contributor, :nested_ordered_bstract, :license, :resource_type, :doi, :dates_section, :degree_level, :degree_name, :degree_field, :degree_grantors, :graduation_year, :contributor_advisor, :contributor_committeemember, :bibliographic_citation, :academic_affiliation, :other_affiliation, :in_series, :subject, :nested_ordered_tableofcontents, :rights_statement] | super
      end
