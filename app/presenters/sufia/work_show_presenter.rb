module Sufia
  class WorkShowPresenter < ::CurationConcerns::WorkShowPresenter
    ...
    delegate :based_near, :keyword, :related_url, :depositor, :identifier, :resource_type, :accepted, :available, :copyrighted, :collected, :issued, :valid, :itemtype, :nested_geo_points, :nested_geo_bbox, :nested_geo_location, to: :solr_document
