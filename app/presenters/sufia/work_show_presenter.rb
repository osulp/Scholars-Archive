module Sufia
  class WorkShowPresenter < ::CurationConcerns::WorkShowPresenter
    ...
    delegate :based_near, :related_url, :depositor, :identifier, :resource_type, :tags, :accepted, :date, :available, :copyrighted, :collected, :issued, :valid_date, to: :solr_document
