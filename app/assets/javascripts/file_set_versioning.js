...
$(document).ready(function() {
  $('#file_set_files').on('input', function(event) {
    ...
    var warningElem = '<div id="title-warning" class="alert alert-warning" role="alert"><strong>Warning:</strong> The title of this fileset has changed to match the above file name.<br/><a href="#descriptions_display">Check the description tab to verify your title</a></div>';
