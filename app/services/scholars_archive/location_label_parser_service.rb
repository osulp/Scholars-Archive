...
module ScholarsArchive
  # CLASS: Location Label Parser Service
  class LocationLabelParserService
    ...
    def self.location_parse_uris(labels)
      ...
      labels.each_with_index do |val, ind|
        ...
        new_loc_str = ScholarsArchive::LocationLabelParserService.new.string_parse(str_arr)
