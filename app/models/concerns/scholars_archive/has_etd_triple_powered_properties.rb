  ...
  module HasEtdTriplePoweredProperties
    ...
    included do
      ...
      def triple_powered_properties
        [{ field: :other_affiliation, has_date: false, skip_validation: false }, { field: :degree_field, has_date: false, skip_validation: false }, { field: :degree_grantors, has_date: false, skip_validation: false }]
      end
    end
  end
end
