...
module Hyrax
  ...
  class Statistic < ActiveRecord::Base
    ...
    class << self
      ...
      # OVERRIDE FROM HYRAX: Use SOLR Faceting rather than HUGE solr queries
      # Related Hyrax PR: https://github.com/samvera/hyrax/pull/6865
      # Will probably require v5 upgrade or later to remove
