...
module ScholarsArchive
  class HandlesController < ApplicationController
    ...
    def handle_file_404; end

    def handle_work_404; end
    ...
    def construct_fileset_querystring(file, format)
      ...
      "#{escaped.tr(' ', '*').gsub('%20', '*').tr('_', '*').tr('+', '*')}.#{format}"
    end
