...
RSpec.describe Default do
  ...
  describe 'decade facets' do
    ...
    context 'when no date' do
      context 'when and no other usable date' do
        let(:asset) do
          g = described_class.new(keyword: ['test'])
          g.attributes = {
            date_created: nil,
      ...
      context 'when but date_created present' do
        let(:asset) do
          g = described_class.new(keyword: ['test'])
          g.attributes = {
      ...
      context 'when but copyright date present' do
        let(:asset) do
          g = described_class.new(keyword: ['test'])
          g.attributes = {
    ...
    context 'when given a date range' do
      ...
      context 'when which spans decades' do
        let(:date) { '1910-1920' }

        it 'has two entries' do
          expect(facet).to eq ['1910-1919', '1920-1929']
        end
        context 'when which is more than 30 years' do
          let(:date) { '1900-1940' }
