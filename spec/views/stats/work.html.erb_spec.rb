...
#
describe 'stats/work.html.erb', type: :view do
  describe 'usage statistics' do
    before :each do
      allow_message_expectations_on_nil
      assign(:stats, stats)
      allow(controller).to receive(:current_ability).and_return(ability)
      allow(view).to receive(:present_about_work_stats_block).and_return(about_stats_text)
      allow(view).to receive(:present_about_work_stats_graph_block).and_return(about_stats_text)
      allow(view).to receive(:present_about_work_stats_overview_block).and_return(about_stats_text)
      allow(view).to receive(:present_about_work_stats_table_block).and_return(about_stats_text)
      ...
      stub_template "_page_view_table.html.erb" => "This content"
    end
    ...
    let(:about_stats_text) { ContentBlock.new(name: "about_work_stats_text", value: about_stats_value) }
