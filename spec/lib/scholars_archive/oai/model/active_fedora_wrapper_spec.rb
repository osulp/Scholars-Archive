...
describe ScholarsArchive::OAI::Model::ActiveFedoraWrapper do
  context "when initiated with a generic asset" do
    subject {ScholarsArchive::OAI::Model::ActiveFedoraWrapper.new(GenericAsset, :limit=>10)}
    let(:collection_1) do
    ...
    describe "#find" do
      ...
      context "when given a limit" do
        ...
        subject {ScholarsArchive::OAI::Model::ActiveFedoraWrapper.new(GenericAsset, :limit => 1)}
      ...
      context "but at the end of the set" do
        ...
        subject {ScholarsArchive::OAI::Model::ActiveFedoraWrapper.new(GenericAsset, :limit => 2)}
      ...
      context "when there are no results for one chunk" do
        ...
        before do
          ...
          generic_asset_3.descMetadata.primarySet = RDF::URI("http://ir.library.oregonstate.edu/resource/scholarsarchive:badset")
          generic_asset_3.save
          generic_asset_5.descMetadata.title = ["five"]
          generic_asset_5.descMetadata.primarySet = RDF::URI("http://ir.library.oregonstate.edu/resource/scholarsarchive:badset")
          generic_asset_5.save
          generic_asset_6.descMetadata.title = ["six"]
          generic_asset_3.descMetadata.primarySet = RDF::URI("http://ir.library.oregonstate.edu/resource/scholarsarchive:badset")
          generic_asset_6.save
        end
        subject {ScholarsArchive::OAI::Model::ActiveFedoraWrapper.new(GenericAsset, :qry_rows =>2, :limit => 2)}
      ...
      context "when given an id" do
        it "should return that record" do
          ...
          expect(subject.find("oai:ir.library.oregonstate.edu:#{coll_id}/#{asset_id}").title).to eq generic_asset_1.title
        end
      end
    ...
    describe "#sets" do
      ...
      before do
        collection_1
        collection_2
        generic_asset_1.descMetadata.primarySet = RDF::URI("http://ir.library.oregonstate.edu/resource/" + collection_1.id)
        generic_asset_1.save
      end
