...
describe ScholarsArchive::LabelAndOrderedParserService do
  let(:labels) { ['label1$www.blah.com$0', 'label2$www.blah.com$1'] }
  ...
  describe '#parse_label_uris' do
    it 'returns a hash of label and uri from a uri$label$index string' do
      expect(described_class.parse_label_uris(labels)).to eq [{ 'label' => 'label1', 'uri' => 'www.blah.com', 'index' => '0' }, { 'label' => 'label2', 'uri' => 'www.blah.com', 'index' => '1' }]
    end
  end
