...
RSpec.describe ScholarsArchive::Actors::AddOtherFieldOptionActor do
  ...
  describe '#create' do
    ...
    context 'when persists valid values' do
    ...
    context 'when should not persist invalid values' do
  ...
  describe '#update' do
    ...
    context 'when persist valid values' do
    ...
    context 'when should not persist options in the database given invalid values' do
      let(:test_degree_level_other) { '' }
      let(:test_degree_field_other) { [''] }
      let(:test_degree_name_other) { [''] }
      let(:test_degree_grantors_other) { '' }
