...
RSpec.feature 'Create a Graduate Project', skip: true, type: :feature do
  context 'a logged in user' do
    ...
    it do
      ...
      choose 'Graduate Project works'
      click_button 'Create work'
      fill_in 'Title', with: 'Test Graduate Project'
      fill_in 'Creator', with: 'Test Graduate Project Creator'
      fill_in 'Keyword', with: 'Test Graduate Project Keyword'
      ...
      expect(page).to have_content 'Test Graduate Project'
    end
  end
end
