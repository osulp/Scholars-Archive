...
RSpec.feature 'Create a Administrative Report Or Publication', skip: true, type: :feature do
  context 'a logged in user' do
    ...
    it do
      ...
      choose 'Administrative Report Or Publication works'
      click_button 'Create work'
      fill_in 'Title', with: 'Test Administrative Report Or Publication'
      fill_in 'Creator', with: 'Test Administrative Report Or Publication Creator'
      fill_in 'Keyword', with: 'Test Administrative Report Or Publication Keyword'
      ...
      expect(page).to have_content 'Test Administrative Report Or Publication'
    end
  end
end
