...
RSpec.feature 'Create a Conference Proceedings Or Journal', skip: true, type: :feature do
  context 'a logged in user' do
    ...
    it do
      ...
      choose 'Conference Proceedings Or Journal works'
      click_button 'Create work'
      fill_in 'Title', with: 'Test Conference Proceedings Or Journal'
      fill_in 'Creator', with: 'Test Conference Proceedings Or Journal Creator'
      fill_in 'Keyword', with: 'Test Conference Proceedings Or Journal Keyword'
      ...
      expect(page).to have_content 'Test Conference Proceedings Or Journal'
    end
  end
end
